...
This repository provides a reproducible development environment together with a
simplified setup and validation workflow for the UniP manipulation baseline.

The goal is to reduce environment setup effort while keeping the original
