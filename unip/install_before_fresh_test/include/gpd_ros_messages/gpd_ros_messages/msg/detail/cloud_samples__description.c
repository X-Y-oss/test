  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static rosidl_type_hash_t hash = {1, {
      0xb6, 0x34, 0x0c, 0x2e, 0x7d, 0xcc, 0xb0, 0xa2,
      0x39, 0x91, 0x19, 0xb9, 0xce, 0xad, 0x9c, 0x91,
      0x31, 0xef, 0xe0, 0x77, 0x71, 0x5a, 0x63, 0xa6,
      0x56, 0x0d, 0xfe, 0x88, 0xea, 0x2a, 0x00, 0xae,
    }};
  return &hash;
}
...
static char gpd_ros_messages__msg__CloudSamples__TYPE_NAME[] = "gpd_ros_messages/msg/CloudSamples";
...
static char gpd_ros_messages__msg__CloudSamples__FIELD_NAME__cloud_sources[] = "cloud_sources";
static char gpd_ros_messages__msg__CloudSamples__FIELD_NAME__samples[] = "samples";

static rosidl_runtime_c__type_description__Field gpd_ros_messages__msg__CloudSamples__FIELDS[] = {
  {
    {gpd_ros_messages__msg__CloudSamples__FIELD_NAME__cloud_sources, 13, 13},
    {
  ...
  {
    {gpd_ros_messages__msg__CloudSamples__FIELD_NAME__samples, 7, 7},
    {
...
static rosidl_runtime_c__type_description__IndividualTypeDescription gpd_ros_messages__msg__CloudSamples__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      {gpd_ros_messages__msg__CloudSamples__TYPE_NAME, 33, 33},
      {gpd_ros_messages__msg__CloudSamples__FIELDS, 2, 2},
    },
    {gpd_ros_messages__msg__CloudSamples__REFERENCED_TYPE_DESCRIPTIONS, 7, 7},
  };
  if (!constructed) {
...
gpd_ros_messages__msg__CloudSamples__get_individual_type_description_source(
  const rosidl_message_type_support_t * type_support)
{
  (void)type_support;
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *gpd_ros_messages__msg__CloudSamples__get_individual_type_description_source(NULL),
