...
{
  new (message_memory) gpd_ros_messages::msg::CloudIndexed(_init);
}

void CloudIndexed_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gpd_ros_messages::msg::CloudIndexed *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CloudIndexed_message_member_array[2] = {
  {
    ...
    offsetof(gpd_ros_messages::msg::CloudIndexed, cloud_sources),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpd_ros_messages::msg::CloudIndexed, indices),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CloudIndexed_message_members = {
  ...
  2,  // number of fields
  sizeof(gpd_ros_messages::msg::CloudIndexed),
...
get_message_type_support_handle<gpd_ros_messages::msg::CloudIndexed>()
{
  return &::gpd_ros_messages::msg::rosidl_typesupport_introspection_cpp::CloudIndexed_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpd_ros_messages, msg, CloudIndexed)() {
  return &::gpd_ros_messages::msg::rosidl_typesupport_introspection_cpp::CloudIndexed_message_type_support_handle;
}
