...
static char gpd_ros_messages__msg__CloudSources__FIELD_NAME__cloud[] = "cloud";
static char gpd_ros_messages__msg__CloudSources__FIELD_NAME__camera_source[] = "camera_source";
static char gpd_ros_messages__msg__CloudSources__FIELD_NAME__view_points[] = "view_points";

static rosidl_runtime_c__type_description__Field gpd_ros_messages__msg__CloudSources__FIELDS[] = {
  {
    {gpd_ros_messages__msg__CloudSources__FIELD_NAME__cloud, 5, 5},
    {
  ...
  {
    {gpd_ros_messages__msg__CloudSources__FIELD_NAME__camera_source, 13, 13},
    {
  ...
  {
    {gpd_ros_messages__msg__CloudSources__FIELD_NAME__view_points, 11, 11},
    {
      rosidl_runtime_c__type_description__FieldType__FIELD_TYPE_NESTED_TYPE_UNBOUNDED_SEQUENCE,
      0,
      0,
...
static rosidl_runtime_c__type_description__IndividualTypeDescription gpd_ros_messages__msg__CloudSources__REFERENCED_TYPE_DESCRIPTIONS[] = {
  {
  ...
  static const rosidl_runtime_c__type_description__TypeDescription description = {
    {
      ...
      {gpd_ros_messages__msg__CloudSources__FIELDS, 3, 3},
    },
    {gpd_ros_messages__msg__CloudSources__REFERENCED_TYPE_DESCRIPTIONS, 6, 6},
  };
  if (!constructed) {
  ...
  const rosidl_message_type_support_t * type_support)
{
  ...
  static bool constructed = false;
  if (!constructed) {
    sources[0] = *gpd_ros_messages__msg__CloudSources__get_individual_type_description_source(NULL),
