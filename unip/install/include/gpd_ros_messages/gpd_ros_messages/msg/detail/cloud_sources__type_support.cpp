...
{
  new (message_memory) gpd_ros_messages::msg::CloudSources(_init);
}

void CloudSources_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gpd_ros_messages::msg::CloudSources *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember CloudSources_message_member_array[3] = {
  {
    ...
    offsetof(gpd_ros_messages::msg::CloudSources, cloud),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpd_ros_messages::msg::CloudSources, camera_source),  // bytes offset in struct
    nullptr,  // default value
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpd_ros_messages::msg::CloudSources, view_points),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers CloudSources_message_members = {
  ...
  3,  // number of fields
  sizeof(gpd_ros_messages::msg::CloudSources),
...
get_message_type_support_handle<gpd_ros_messages::msg::CloudSources>()
{
  return &::gpd_ros_messages::msg::rosidl_typesupport_introspection_cpp::CloudSources_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpd_ros_messages, msg, CloudSources)() {
  return &::gpd_ros_messages::msg::rosidl_typesupport_introspection_cpp::CloudSources_message_type_support_handle;
}
