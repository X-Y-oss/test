...
{
  new (message_memory) gpd_ros_messages::msg::SamplesMsg(_init);
}

void SamplesMsg_fini_function(void * message_memory)
{
  auto typed_message = static_cast<gpd_ros_messages::msg::SamplesMsg *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember SamplesMsg_message_member_array[2] = {
  {
    ...
    offsetof(gpd_ros_messages::msg::SamplesMsg, header),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(gpd_ros_messages::msg::SamplesMsg, samples),  // bytes offset in struct
    nullptr,  // default value
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers SamplesMsg_message_members = {
  ...
  2,  // number of fields
  sizeof(gpd_ros_messages::msg::SamplesMsg),
...
get_message_type_support_handle<gpd_ros_messages::msg::SamplesMsg>()
{
  return &::gpd_ros_messages::msg::rosidl_typesupport_introspection_cpp::SamplesMsg_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, gpd_ros_messages, msg, SamplesMsg)() {
  return &::gpd_ros_messages::msg::rosidl_typesupport_introspection_cpp::SamplesMsg_message_type_support_handle;
}
