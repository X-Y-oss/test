...
class Metaclass_DetectGrasps_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('gpd_ros_messages')
        except ImportError:
            import logging
            import traceback
            ...
            from gpd_ros_messages.msg import CloudIndexed
...
class DetectGrasps_Request(metaclass=Metaclass_DetectGrasps_Request):
    ...
    _fields_and_field_types = {
        'cloud_indexed': 'gpd_ros_messages/CloudIndexed',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['gpd_ros_messages', 'msg'], 'CloudIndexed'),  # noqa: E501
    )
...
class DetectGrasps_Response(metaclass=Metaclass_DetectGrasps_Response):
    ...
    _fields_and_field_types = {
        'grasp_configs': 'gpd_ros_messages/GraspConfigList',
    }

    # This attribute is used to store an rosidl_parser.definition variable
    # related to the data type of each of the components the message.
    SLOT_TYPES = (
        rosidl_parser.definition.NamespacedType(['gpd_ros_messages', 'msg'], 'GraspConfigList'),  # noqa: E501
    )
...
class Metaclass_DetectGrasps_Event(type):
    """Metaclass of message 'DetectGrasps_Event'."""
    ...
    def __import_type_support__(cls):
        try:
            ...
            cls._CREATE_ROS_MESSAGE = module.create_ros_message_msg__srv__detect_grasps__event
            cls._CONVERT_FROM_PY = module.convert_from_py_msg__srv__detect_grasps__event
            cls._CONVERT_TO_PY = module.convert_to_py_msg__srv__detect_grasps__event
            cls._TYPE_SUPPORT = module.type_support_msg__srv__detect_grasps__event
            cls._DESTROY_ROS_MESSAGE = module.destroy_ros_message_msg__srv__detect_grasps__event
...
class DetectGrasps_Event(metaclass=Metaclass_DetectGrasps_Event):
    """Message class 'DetectGrasps_Event'."""
    ...
    _fields_and_field_types = {
        ...
        'request': 'sequence<gpd_ros_messages/DetectGrasps_Request, 1>',
        'response': 'sequence<gpd_ros_messages/DetectGrasps_Response, 1>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gpd_ros_messages', 'srv'], 'DetectGrasps_Request'), 1),  # noqa: E501
        rosidl_parser.definition.BoundedSequence(rosidl_parser.definition.NamespacedType(['gpd_ros_messages', 'srv'], 'DetectGrasps_Response'), 1),  # noqa: E501
    )
    ...
    def request(self, value):
        if self._check_fields:
            from gpd_ros_messages.srv import DetectGrasps_Request
            ...
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 len(value) <= 1 and
                 all(isinstance(v, DetectGrasps_Request) for v in value) and
                 True), \
                "The 'request' field must be a set or sequence with length <= 1 and each value of type 'DetectGrasps_Request'"
        self._request = value
    ...
    def response(self, value):
        if self._check_fields:
            from gpd_ros_messages.srv import DetectGrasps_Response
            from collections.abc import Sequence
            from collections.abc import Set
            from collections import UserList
            from collections import UserString
            assert \
                ((isinstance(value, Sequence) or
                 ...
                 not isinstance(value, UserString) and
                 len(value) <= 1 and
                 all(isinstance(v, DetectGrasps_Response) for v in value) and
                 True), \
                "The 'response' field must be a set or sequence with length <= 1 and each value of type 'DetectGrasps_Response'"
...
class Metaclass_DetectGrasps(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'gpd_ros_messages.srv.DetectGrasps')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from gpd_ros_messages.srv import _detect_grasps
            ...
            if _detect_grasps.Metaclass_DetectGrasps_Event._TYPE_SUPPORT is None:
                _detect_grasps.Metaclass_DetectGrasps_Event.__import_type_support__()


class DetectGrasps(metaclass=Metaclass_DetectGrasps):
    from gpd_ros_messages.srv._detect_grasps import DetectGrasps_Request as Request
    from gpd_ros_messages.srv._detect_grasps import DetectGrasps_Response as Response
    from gpd_ros_messages.srv._detect_grasps import DetectGrasps_Event as Event
