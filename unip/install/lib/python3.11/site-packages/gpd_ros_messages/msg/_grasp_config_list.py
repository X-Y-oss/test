    ...
    def __import_type_support__(cls):
        try:
            ...
            logger = logging.getLogger(
                'gpd_ros_messages.msg.GraspConfigList')
            logger.debug(
            ...
            from gpd_ros_messages.msg import GraspConfig
...
class GraspConfigList(metaclass=Metaclass_GraspConfigList):
    ...
    _fields_and_field_types = {
        ...
        'grasps': 'sequence<gpd_ros_messages/GraspConfig>',
    }
    ...
    SLOT_TYPES = (
        ...
        rosidl_parser.definition.UnboundedSequence(rosidl_parser.definition.NamespacedType(['gpd_ros_messages', 'msg'], 'GraspConfig')),  # noqa: E501
    )
