...
bool gpd_ros_messages__msg__cloud_sources__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("gpd_ros_messages.msg._cloud_sources.CloudSources", full_classname_dest, 48) == 0);
  }
  gpd_ros_messages__msg__CloudSources * ros_message = _ros_message;
  {  // cloud
...
PyObject * gpd_ros_messages__msg__cloud_sources__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("gpd_ros_messages.msg._cloud_sources");
